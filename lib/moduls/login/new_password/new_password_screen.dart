                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Neumorphic(
                              ...
                              child: TextFormField(
                                obscureText: cubit.isShowPassword['newPassword']!,
                                decoration: InputDecoration(
                                  suffixIcon: IconButton(
                                    onPressed: () {
                                      cubit.changePasswordVisibility('newPassword');
                                    },
                                    icon: Icon(
                            ...
                            Neumorphic(
                              ...
                              child: TextFormField(
                                obscureText: cubit.isShowPassword['confirmPassword']!,
                                decoration: InputDecoration(
                                  suffixIcon: IconButton(
                                    onPressed: () {
                                      cubit.changePasswordVisibility('confirmPassword');
                                    },
                                    icon: Icon(
                                      cubit.isShowPassword['confirmPassword']!
                                          ? Icons.visibility_off_outlined
                                          : Icons.visibility_outlined,
                                    ),
                                  ),
